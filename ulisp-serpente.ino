/* uLisp Serpente 3.0 - www.ulisp.com
   David Johnson-Davies - www.technoblogy.com - 28th December 2019
...
#if defined(ARDUINO_SERPENTE)
  #define WORKSPACESIZE 3072-SDSIZE       /* Objects (8*bytes) */
  #define DATAFLASHSIZE 4096000           /* 4 MBytes */
...
// Winbond DataFlash support for Serpente
...
#if defined(ARDUINO_SERPENTE)
  if (!(pin>=0 && pin<=8)) error(ANALOGWRITE, invalidpin, number(pin));
#endif
}
